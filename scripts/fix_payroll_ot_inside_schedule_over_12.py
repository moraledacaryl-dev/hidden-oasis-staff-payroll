...
if old not in s:
    raise SystemExit('Expected scheduled-window payroll block not found. Run the previous scheduled-window patch first or inspect core/payroll_engine.py around compute_overlap.')

s = s.replace(old, new, 1)
p.write_text(s)
print('Patched payroll: OT is approved outside-schedule time plus inside-schedule time beyond 12 hours.')
