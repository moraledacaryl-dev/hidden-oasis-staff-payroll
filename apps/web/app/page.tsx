      ...
      <div className="page">
        <header className="page-header">
          <div className="grid">
            ...
            <p className="muted">Next.js is connected to FastAPI. Payroll values are computed by the existing Python engine.</p>
          </div>
        ...
        <section className="grid cols-2">
          <div className="card">
            <div className="panel-title"><div><h2>Cutoff readiness</h2><p className="muted">QA from the existing payroll preflight checker.</p></div><div className="badge-row"><StatusBadge label={`${blockers} blockers`} tone={blockers ? "danger" : "ok"} /><StatusBadge label={`${warnings} warnings`} tone={warnings ? "warning" : "ok"} /></div></div>
          ...
          <div className="card">
            <div className="panel-title"><div><h2>Migration safety</h2><p className="muted">Do-not-break controls for this stage.</p></div><StatusBadge label="safe stage" /></div>
            <div className="action-list"><div className="action-item"><strong>Streamlit remains fallback.</strong><p className="muted">The current app is not deleted or replaced.</p></div><div className="action-item"><strong>SQLite remains source database.</strong><p className="muted">PostgreSQL migration happens later only after comparison.</p></div><div className="action-item"><strong>Payroll formulas stay in Python.</strong><p className="muted">Next.js calls the API and does not calculate payroll.</p></div><div className="action-item"><strong>Write actions disabled.</strong><p className="muted">Preview is read-only until totals match the Streamlit app.</p></div></div>
          </div>
        </section>
      </div>
    </Shell>
