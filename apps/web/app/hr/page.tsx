...
export default async function HrPage() {
  ...
  const [employees, leaveEmployees, records, leaveRequests] = loaded.map((result) => result.status === "fulfilled" ? result.value : []) as [Employee[], LeaveEmployee[], HrRecord[], LeaveRequestItem[]];
  ...
  return (
    <Shell allowedRoles={["owner", "payroll", "supervisor"]}>
      <div className="page">
        <header className="page-header"><div><span className="eyebrow">People</span><h1>HR records</h1></div></header>
        ...
        {canCreate ? <section className="card"><div className="panel-title"><h2>Add HR record</h2></div><HrRecordForm employees={employees} /></section> : null}
