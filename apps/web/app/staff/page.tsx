      ...
      <div className="page">
        ...
        <section className="card">
          <div className="panel-title">
            <div>
              <h2>Employees</h2>
              <p className="muted">The production UI should make this editable later with audit logs and permissions.</p>
            </div>
          </div>
                  ...
                  <tr key={employee.id}>
                    ...
                    <td>
                      <div className="badge-row">
                        {employee.benefits_sss ? <span className="badge">SSS</span> : null}
                        {employee.benefits_philhealth ? <span className="badge">PhilHealth</span> : null}
                        {employee.benefits_pagibig ? <span className="badge">Pag-IBIG</span> : null}
                        {employee.benefits_tax ? <span className="badge">Tax</span> : null}
                      </div>
                    </td>
                  </tr>
                ))}
