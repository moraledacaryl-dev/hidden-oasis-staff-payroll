  ...
  return (
    <Shell allowedRoles={["owner", "supervisor"]}>
      <div className="page">
        ...
        <section className="grid cols-3"><div className="card"><strong>{exceptions.length} attendance exception(s)</strong><p className="muted">Missing, pending, absent, incomplete, or OT-pending logs.</p></div><div className="card"><strong>OT decisions</strong><p className="muted">Approve/reject with reason; backend writes an audit entry.</p></div><div className="card"><strong>Payroll still locked</strong><p className="muted">This does not create, approve, or pay payroll runs.</p></div></section>
