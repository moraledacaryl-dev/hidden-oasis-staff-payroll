  ...
  return (
    <Shell allowedRoles={["owner", "payroll", "supervisor"]}>
      <div className="page">
        ...
        <section className="card"><div className="panel-title"><div><h2>Add planned shift</h2><p className="muted">This creates a scheduled baseline shift only. It does not create payroll, time logs, OT, or release pay.</p></div></div><ScheduleShiftForm weekStart={week.week_start} /></section>
