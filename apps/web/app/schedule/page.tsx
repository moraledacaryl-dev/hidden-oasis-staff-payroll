  ...
  return (
    <Shell allowedRoles={["owner", "payroll", "supervisor"]}>
      <div className="page">
        ...
        <section className="card"><div className="panel-title"><h2>Week</h2></div><ScheduleBoardClient days={days} shifts={filteredItems} employees={employees} canEdit={canEditSchedule} /></section>
      </div>
    </Shell>
  );
}
