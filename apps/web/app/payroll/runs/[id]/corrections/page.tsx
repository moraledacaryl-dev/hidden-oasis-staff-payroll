      ...
      <div className="page">
        ...
        <section className="card">
          ...
          <div className="table-wrap">
            <table>
              <thead><tr><th>Created</th><th>Employee</th><th>Type</th><th>Status</th><th>Amount</th><th>Reason</th><th>Next run</th><th>By</th></tr></thead>
              <tbody>
                {corrections.items.map((item) => (
                  <tr key={item.id}>
                    ...
                    <td>{item.status || "Recorded"}{item.applied_to_run_id ? ` → Run #${item.applied_to_run_id}` : ""}</td>
                ...
                {!corrections.items.length ? <tr><td colSpan={8}>No corrections recorded for this run.</td></tr> : null}
              </tbody>
            </table>
          </div>
        </section>
