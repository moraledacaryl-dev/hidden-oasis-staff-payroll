...
export default async function PayrollPage() {
  ...
  return (
    <Shell allowedRoles={["owner", "payroll"]}>
      <div className="page">
        <header className="page-header"><div className="grid"><span className="eyebrow">Payroll</span><h1>Cutoff preview</h1><p className="muted">Check totals before saving a run.</p></div><div className="badge-row"><StatusBadge label={`${DEFAULT_START} to ${DEFAULT_END}`} tone="warning" /><StatusBadge label={preview.mode} tone="warning" /></div></header>
