    ...
    <Shell allowedRoles={["owner", "payroll", "supervisor"]}>
      <div className="page cutoff-page">
        ...
        <section className="card cutoff-review-card">
          {session.role_key === "payroll" ? <p className="form-feedback">An Owner or General Manager must resolve attendance decisions. Attendance review links open the source schedule for inspection.</p> : null}
