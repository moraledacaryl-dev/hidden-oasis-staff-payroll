...
export type AttendanceImport = { id: number; file_name: string; imported_at: string; imported_by?: string | null; row_count: number; summary?: { ready?: number; needs_review?: number; errors?: number; skipped?: number } };
export type AttendanceImportsResponse = { ok: boolean; items: AttendanceImport[] };
...
export function getAttendanceImports(limit = 10): Promise<AttendanceImportsResponse> { return apiGet<AttendanceImportsResponse>(`/api/v1/attendance/imports?limit=${limit}`, true); }
