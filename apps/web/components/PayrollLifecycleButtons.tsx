  ...
  return (
    <>
      ...
      <ConfirmActionModal
        ...
        description="This finalizes payment and applies cash-advance repayments, reducing outstanding employee balances. Verify payment completion before continuing."
        confirmLabel="Mark Paid"
        confirmationText="MARK PAID"
        danger
        busy={busy === "paid"}
